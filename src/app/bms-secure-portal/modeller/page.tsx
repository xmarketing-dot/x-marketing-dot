        ...
        >
          ...
          >
            ...
            <form onSubmit={handleSave} className="flex flex-col gap-4 text-xs font-heading">
              ...
              {/* ── FİZİKSEL BİLGİLER TABLOSU ──────────────── */}
              <div className="p-4 rounded-2xl bg-[#0d1117] border border-rose-500/40 flex flex-col gap-3">
                <span className="text-xs font-black text-rose-400 uppercase tracking-wider flex items-center gap-1.5">
                  <Crown className="w-4 h-4" />
                  <span>Fiziksel Biyometri &amp; Kişisel Nitelikler</span>
                </span>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
                  <label className="flex flex-col gap-1 text-[11px] font-bold text-[#8b949e]">
                    ...
                    <input
                      type="number"
                      value={formData.yas}
                      onChange={(e) => setFormData({ ...formData, yas: Number(e.target.value) })}
                      className="px-3 py-2 rounded-xl bg-[#161b22] border border-[#30363d] text-white text-xs focus:outline-none focus:border-rose-400"
                    />
                  </label>
                  ...
                  <label className="flex flex-col gap-1 text-[11px] font-bold text-[#8b949e]">
                    ...
                    <input
                      type="number"
                      value={formData.boy}
                      onChange={(e) => setFormData({ ...formData, boy: Number(e.target.value) })}
                      className="px-3 py-2 rounded-xl bg-[#161b22] border border-[#30363d] text-white text-xs focus:outline-none focus:border-rose-400"
                    />
                  </label>
                  ...
                  <label className="flex flex-col gap-1 text-[11px] font-bold text-[#8b949e]">
                    ...
                    <input
                      type="number"
                      value={formData.kilo}
                      onChange={(e) => setFormData({ ...formData, kilo: Number(e.target.value) })}
                      className="px-3 py-2 rounded-xl bg-[#161b22] border border-[#30363d] text-white text-xs focus:outline-none focus:border-rose-400"
                    />
                  </label>
                  ...
                  <label className="flex flex-col gap-1 text-[11px] font-bold text-[#8b949e]">
                    ...
                    <input
                      type="text"
                      value={formData.gogusOlcusu}
                      onChange={(e) => setFormData({ ...formData, gogusOlcusu: e.target.value })}
                      className="px-3 py-2 rounded-xl bg-[#161b22] border border-[#30363d] text-white text-xs focus:outline-none focus:border-rose-400"
                    />
                  </label>
                  ...
                  <label className="flex flex-col gap-1 text-[11px] font-bold text-[#8b949e]">
                    ...
                    <input
                      type="text"
                      value={formData.sacRengi}
                      onChange={(e) => setFormData({ ...formData, sacRengi: e.target.value })}
                      className="px-3 py-2 rounded-xl bg-[#161b22] border border-[#30363d] text-white text-xs focus:outline-none focus:border-rose-400"
                    />
                  </label>
                  ...
                  <label className="flex flex-col gap-1 text-[11px] font-bold text-[#8b949e]">
                    ...
                    <input
                      type="text"
                      value={formData.gozRengi}
                      onChange={(e) => setFormData({ ...formData, gozRengi: e.target.value })}
                      className="px-3 py-2 rounded-xl bg-[#161b22] border border-[#30363d] text-white text-xs focus:outline-none focus:border-rose-400"
                    />
                  </label>
                  ...
                  <label className="flex flex-col gap-1 text-[11px] font-bold text-[#8b949e]">
                    ...
                    <input
                      type="text"
                      value={formData.burc}
                      onChange={(e) => setFormData({ ...formData, burc: e.target.value })}
                      className="px-3 py-2 rounded-xl bg-[#161b22] border border-[#30363d] text-white text-xs focus:outline-none focus:border-rose-400"
                    />
                  </label>
