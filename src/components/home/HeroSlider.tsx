            ...
            <div className="relative z-30 px-3.5 sm:px-5 pb-4 pt-1 flex flex-col gap-2 w-full max-w-2xl mx-auto text-left drop-shadow-2xl">
              ...
              <div className="w-full pt-0.5">
                <Link href={`/ilan/${current.slug}`} className="block group/title">
                  <h2 className="font-heading font-black text-xl sm:text-3xl md:text-4xl text-white tracking-tight leading-tight drop-shadow-[0_4px_16px_rgba(0,0,0,0.95)] group-hover/title:text-amber-300 transition-colors line-clamp-2">
                    {current.baslik}
                  </h2>
                </Link>
              </div>
